...
<div class="col-md-12">
    <div class="card card-info">
        <div class="card-header">
            <h2 class="card-title">Data perencanaan Warga</h2>
            ...
            <table id="example1" class="table table-bordered table-striped ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $dt->name }}</td>
                        <td>{{ $dt->umur }}</td>
                        <td class="{{ $dt->penghasilan < 500000 ? 'text-danger' : 'text-success' }}">
                            {{ $dt->penghasilan < 500000 ? 'Kurang Mampu' : 'Mampu' }}
                        </td>
                        <td>{{ $dt->pekerjaan }}</td>
                        <td>{{ $dt->tempat_tinggal }}</td>
